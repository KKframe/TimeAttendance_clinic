...
<html>
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
        ...
        <h1 class="logo mr-auto"><a href=""><img src="assets/img/lg.png"></a></h1>
            ...
            <ul>
              <li class="drop-down active"><a href="">เมนู</a>
                <ul>
                    <li><a href="hist_work.php">ประวัติการเข้าออกเวร</a></li>
                    <li><a href="check_in.php">บันทึกเวลาเข้าเวร</a></li>
                    <li><a href="check_out.php">บันทึกเวลาออกเวร</a></li>
        ...
        <div class="d-flex align-items-center ">
         <div class='col-6 '><img class="RoundImg" src="assets/img/staff/<?php echo $_SESSION['รูปประจำตัว']?>" ></div>
            <div class='col-6 '><h1 style='font-size: "24px";font-family: "Itim";text-align: left;'>
                <?php echo "รหัสเจ้าหน้าที่: ".$_SESSION["รหัสผู้ใช้ระบบ"]."<br>".
                            "ตำแหน่ง: ".$_SESSION["ตำแหน่ง"]."<br>".
                            "ชื่อ: ".$_SESSION['Username']."<br>".
                            "นามสกุล: ".$_SESSION['นามสกุล']."<br>";?></h1>
            </div>
        </div>
    ...
    <div class="d-flex align-items-center ">
        ...
        <div style=" position: absolute; left: 35%; top: 85%;color: #273D40;text-align: center;font-size: 16px;">
            <p style="color: red;"><strong>หมายเหตุ: </strong>หากเกิน 16:30 น. ถือว่า"สาย"</p>
        </div>
    </div>
