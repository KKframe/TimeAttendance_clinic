...
<div class="container position-relative">
    ...
    border-color:#808080;font-family: 'FC Friday';" class="panel-body panel panel-default ">
                  ...
                  <div style="font-size: 20px;" class="panel-body ">
                    <form action="reset_password.php"  id="register-form" role="form" autocomplete="off" class="form" method="post">
                      ...
                      <div class="form-group">
                          <input style="background-color: #ebc3b9;" name="recover-submit" class=" btn btn-lg btn-block" value="บันทึกรหัสผ่านใหม่" type="submit">
                      </div>
                      </form>
             ...
             <p style="text-align: center;"><strong>คำแนะนำ:</strong> ควรตั้งรหัสผ่าน 6 อักษร ที่ประกอบด้วย
