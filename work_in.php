...
<div class="container fridayFont">
    <div class="d-flex align-items-center">
        <div class='col-9 '><h1>เวลาการเข้าเวรของ <?php echo $_SESSION['ชื่อ'];?></h1></div>
        <div class="col-3"><img src="assets/img/time8.png" style="height: auto; width: 40vh; float: right;"></div>
    </div>
  <br>
    <form action="work_in.php" method="get">
      ...
      <tr>
        <th>วันที่เข้าเวร</th>
        <th>เวลาเข้าเวร</th><th>หมายเหตุ</th>
      </tr>
    </thead><tbody>
 <?php
 if(isset($_GET['textSearch'])) {
    $sql = "SELECT  date_format(วันที่เข้าเวร,'%d/%m/%Y') as วันที่เข้าเวร,เวลาเข้าเวร FROM staff_checkin  where ชื่อเจ้าหน้าที่ ='".$_SESSION['ชื่อ']
    ...
    // output data of each row
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo"<tr>
                    ...
                    <td>".$row["เวลาเข้าเวร"]."</td><td>".$note."</td>
            </tr>";
        }
    echo"</tbody>
     </table>";
